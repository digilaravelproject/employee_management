...
class _AddRoleScreenState extends State<AddRoleScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Try to get dynamic departments and designations if available
      ...
      appBar: AppBar(
        ...
        title: const Column(
          ...
          children: [
            ...
            AppText(
              'Define role details & granular permissions',
              fontSize: 11,
        ...
        actions: [
          Padding(
            ...
            child: Obx(() => ElevatedButton.icon(
              onPressed: controller.isSavingRole.value ? null : () => controller.saveRole(),
              ...
              label: AppText(
                controller.isSavingRole.value ? 'Saving...' : 'Save Role',
                fontSize: 13,
                fontWeight: FontWeight.bold,
                color: Colors.white,
              ),
          ...
          child: Obx(() => ElevatedButton(
            ...
            child: Row(
              ...
              children: [
                ...
                AppText(
                  controller.isSavingRole.value ? 'Saving Role...' : 'Save Role',
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                ),
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: Theme(
              ...
              child: ExpansionTile(
                initiallyExpanded: index == 0, // expand first module by default
                ...
                children: [
                  ...
                  // Individual granular action switches
